        ...
        return (
            <div className={`event-form event-form--${this.props.position}`} onClick={this.onClick}>
                ...
                {event && event.title && edit !== "title"
                    ...
                    :
                    <input type="text"
                           className="event-form_input" name="title"
                ...
                {hasEvent &&
                <div className="event-form__date">{format(day, "D")} {getMonthName(format(day, "M"))}</div>}
                
                {
                    event && event.people && edit !== "people"
                        ?
                        <div className="event-form-event-people" title="редактировать"
                            ...
                            <div className="eqvent-form-event-people__bottom">
                                {this.state.people ? this.state.people : event ? event.people : null}
                            </div>
                        </div>
                        :
                        <input
                ...
                {event && event.description && edit !== "description"
                    ...
                    :
                    <textarea
                        className="event-form_input event-form_textarea"
                        name="description"
                        onChange={this.handleInputChange}
                ...
                <div className="event-form-buttons">
                    {
                        (edit || !hasEvent || !event.title || !event.people || !event.description)
                        &&
                        <button
                            onClick={() => {
